...
public class ChessGameDemo_Queen extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ChessGameDemo_Queen(String pi, int x, int y, int x_1, int y_1, int length){
...
// ++++++++++++++++++++ END +++++++++ COMBINE TWO ELEMENTS FOR THE SUM IS EQUAL TO GIVEN LENGTH +++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		final JTable table = new JTable(combine__x_y, columnNames); // data_values, data_values_1, combine__x_y
	...
	private static void createAndShowGUI(String piece, int x, int y, int x1, int y1, int length) {
		...
		int xx = x;
		int yy = y;
        ChessGameDemo_Queen newContentPane = new ChessGameDemo_Queen(p, xx, yy, x1, y1, length);
		
		//Create and set up the window.
        JFrame frame = new JFrame("ChessGameDemo_Queen");
    ...
    public static void main(String[] args) {
		...
		//ChessGameDemo_Queen obj = new ChessGameDemo_Queen(piece, x, y);
		if(x>7 || y>7 || x<0 || y<0 ) {
