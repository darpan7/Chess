...
public class ChessGameDemo_rook extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ChessGameDemo_rook(String pi, int x, int y){
...
/*
	...
	*/
	...
	private static void createAndShowGUI(String piece, int x, int y) {
		...
		int xx = x;
		int yy = y;
        ChessGameDemo_rook newContentPane = new ChessGameDemo_rook(p, xx, yy);
		
		//Create and set up the window.
        JFrame frame = new JFrame("ChessGameDemo_rook");
    ...
    public static void main(String[] args) {
		...
		System.out.println("Enter piece location Y point(1 to 8):");
		final int y = Integer.parseInt(in.nextLine());
		
		System.out.println("" + piece + " - " + x + "- " + y );
		
		//ChessGameDemo_rook obj = new ChessGameDemo_rook(piece, x, y);
        if(x>7 || y>7 || x<0 || y<0) {
