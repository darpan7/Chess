...
public class ChessGameDemo_Queen extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ChessGameDemo_Queen(String pi, int x, int y){
	...
	private static void createAndShowGUI(String piece, int x, int y) {
		...
		int xx = x;
		int yy = y;
        ChessGameDemo_Queen newContentPane = new ChessGameDemo_Queen(p, xx, yy);
...
/*	    JFrame frame = new ChessGameDemo_Queen(piece, x, y);
