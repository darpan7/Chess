...
public class ChessGameDemo_rook extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ChessGameDemo_rook(String pi, int x, int y, int x_1, int y_1, int length){
...
// ++++++++++++++++++++ END +++++++++ COMBINE TWO ELEMENTS FOR THE SUM IS EQUAL TO GIVEN LENGTH +++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	private static void createAndShowGUI(String piece, int x, int y, int x1, int y1, int length) {
		...
		int xx = x;
		int yy = y;
        ChessGameDemo_rook newContentPane = new ChessGameDemo_rook(p, xx, yy, x1, y1, length);
