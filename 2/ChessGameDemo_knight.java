...
public class ChessGameDemo_knight extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ChessGameDemo_knight(String pi, int x, int y){
	...
	private static void createAndShowGUI(String piece, int x, int y) {
		...
		int xx = x;
		int yy = y;
        ChessGameDemo_knight newContentPane = new ChessGameDemo_knight(p, xx, yy);
		
		//Create and set up the window.
        JFrame frame = new JFrame("ChessGameDemo_knight");
    ...
    public static void main(String[] args) {
		...
		System.out.println("Enter piece name: -knight- :");
		...
		//ChessGameDemo_knight obj = new ChessGameDemo_knight(piece, x, y);
        if(x>7 || y>7 || x<0 || y<0) {
