...
public class ChessGameDemo_bishop extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ChessGameDemo_bishop(String pi, int x, int y){
...
/*
	...
	*/
	...
	private static void createAndShowGUI(String piece, int x, int y) {
		...
		int xx = x;
		int yy = y;
        ChessGameDemo_bishop newContentPane = new ChessGameDemo_bishop(p, xx, yy);
		
		//Create and set up the window.
        JFrame frame = new JFrame("ChessGameDemo_bishop");
    ...
    public static void main(String[] args) {
		...
		System.out.println("Enter piece name: -bishop-: ");
		...
		//ChessGameDemo_bishop obj = new ChessGameDemo_bishop(piece, x, y);
		if(x>7 || y>7 || x<0 || y<0) {
